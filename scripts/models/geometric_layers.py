...
def axisAngle_to_rotationMatrix(theta):
...
def rotationMatrix_to_axisAngle(rotation_matrix):
    ...
    quaternion = rotationMatrix_to_Quaternion(rotation_matrix)
    return quaternion_to_axisAngle(quaternion)

def quaternion_to_axisAngle(quaternion: torch.Tensor) -> torch.Tensor:
    ...
    Example:
        ...
        >>> angle_axis = tgm.quaternion_to_axisAngle(quaternion)  # Nx3
    """
...
def rotationMatrix_to_Quaternion(rotation_matrix, eps=1e-6):
    ...
    Example:
        ...
        >>> output = tgm.rotationMatrix_to_Quaternion(input)  # Nx4
    """
...
def axisAngle_to_Rot6d(x):
    ...
    """
    rotMat = axisAngle_to_rotationMatrix(x)
...
def rot6d_to_axisAngle(x):
    ...
    return rotationMatrix_to_axisAngle(rotMat)
...
#                   [0, 0, np.pi/2],[np.pi/2, np.pi/6, np.pi/3],
#                   [np.pi/5, np.pi*2/3, np.pi/4]])

# axisAngle - rot6d_to_axisAngle(axisAngle_to_Rot6d(axisAngle))