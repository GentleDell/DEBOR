...
class TrainOptions(object):
    ...
    def __init__(self):
        ...
        gen.add_argument('--name', default='structure', help='Name of the experiment')
        ...
        train.add_argument('--checkpoint_steps', type=int, default=2, help='Checkpoint saving frequency')
