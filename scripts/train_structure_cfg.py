...
class TrainOptions(object):
    ...
    def __init__(self):
        ...
        data.add_argument('--MGN_offsMeanStd_path', default='/home/logix/Documents/DEBOR/body_model/offsets_mean_std.npy', help='path to the mean and std of displacement.')
        ...
        gen.add_argument('--name', default='structure_ver1_full_doubleEnc_newdataset_8_ver1.2', help='Name of the experiment')
