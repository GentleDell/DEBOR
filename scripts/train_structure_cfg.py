...
class TrainOptions(object):
    ...
    def __init__(self):
        ...
        data.add_argument('--graph_matrics_path', default='../body_model/mesh_downsampling.npz', help='path to graph adjacency matrix and upsampling/downsampling matrices') 
        data.add_argument('--smpl_model_path', default='../body_model/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl', help='path to SMPL model') 
        data.add_argument('--smpl_objfile_path', default='../body_model/text_uv_coor_smpl.obj', help='path to SMPL .obj file') 
        data.add_argument('--smpl_edges_path', default='../body_model/edges_smpl.npy', help='path to SMPL edges(from CAPE).') 
        data.add_argument('--MGN_avgPose_path', default='../body_model/MGN_train_avgPose.npy', help='path to the average pose of SMPL model in training set.')
        data.add_argument('--MGN_avgBeta_path', default='../body_model/MGN_train_avgBetas.npy', help='path to the average shape of SMPL model in training set.')
        data.add_argument('--MGN_offsMeanStd_path', default='../body_model/offsets_mean_std.npy', help='path to the mean and std of displacement.')
        ...
        gen.add_argument('--name', default='structure_ver1_temp', help='Name of the experiment')
        ...
        train.add_argument('--summary_steps', type=int, default=1024, help='Summary saving frequency')
        train.add_argument('--checkpoint_steps', type=int, default=10000, help='Checkpoint saving frequency')
        train.add_argument('--test_steps', type=int, default=4000, help='Testing frequency')
        ...
        train.add_argument('--augmentation_rot', dest='use_augmentation_rot', default=False, action='store_false', help='rotate image during augmentation') 
