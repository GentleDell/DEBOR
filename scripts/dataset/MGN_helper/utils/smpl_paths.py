...
## Set your paths here
SMPL_PATH = '../../body_model/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
smpl_vt_ft_path = '../../body_model/smpl_vt_ft.pkl'
...
class SmplPaths:
    ...
    def get_hres_smpl_model_data(self):
        ...
        dd = pkl.load(open(self.get_smpl_file(), 'rb'), encoding='iso-8859-1')
    ...
    @staticmethod
    def get_vt_ft():
        vt, ft = pkl.load(open(smpl_vt_ft_path, 'rb'), encoding='iso-8859-1')
        return vt, ft
